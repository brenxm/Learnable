...
## Core Principle
1. // Study a lecture in structured and engaging way for easy absortion of content with assistant chat
2. // Create a lecture with full customization with the support of AI (e.g., order of subjects, content of subjects, tone of delivery)
3. // Share or sell your created lecture at the lecture shop
4. // Reinforcement feature to help retain the topic materials by doing a quiz daily. Each question is utilizing spaced repition technique to ensure retention
5. //
## Study Feature
1. ### Lecture Scene
